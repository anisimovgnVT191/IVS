...
class CommandGGA(commandStr: String): CommandNMEA(commandStr){
    ...
    override val latitude: Double = commandsList[2]?.toDoubleOrNull()?:0.0
    override val indicatorNS: Direction = commandsList[3]!!.toDirection()
    override val longitude: Double = commandsList[4]!!.toDouble()
    ...
    val HDOP: Double = commandsList[8]!!.toDouble()
    val altitudeMSL:Double = commandsList[9]!!.toDouble()
    val units:Char = commandsList[10]!![0]
    val geoidSeparation:Double? = commandsList[11]?.toDoubleOrNull()
    val units1:Char = commandsList[12]!![0]
    val ageOfDiffCorr:Int? = commandsList[13]?.toInt()
